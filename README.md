...
<p>Как решал: 
   ...
   <li>Собрал калькулятор с возможностью настройки текущих метрик как в большую и меньшую сторону</li>
    <li>Сформировал визуализацию по распределению количества студентов и объема платежей за обучение</li>   
  </ol>
...
<ol>
  ...
  <li>Итог №2    Повышение интенсивности занятий в рамках онлайн школы на 13%  - позволяет увеличить маржинальность бизнеса в 2 раза b более (с 9% до 25%) </li>
</ol>
<br> 
